    ...
    <>
        ...
        <form onSubmit={handleOnSubmit}>
          <div>
                ...
                <input type="text"  id='full-name' placeholder='Full Name' onChange={handleOnChange} name='full_name'/>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text"  placeholder='Telephone' onChange={handleOnChange} name='telephone'/>
            </div>
            ...
            <div>
                ...
                <input type="password"  placeholder='Password confirm' onChange={handleOnChange} name='password2'/>
            </div>
